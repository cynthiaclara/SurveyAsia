...
@section('content')
    ...
    <div class="row">
      ...
      @if (session('verified'))
        <div class="alert alert-success col-md-4 col-md-offset-4" role="alert">
          <p>Verifikasi Berhasil<button type="button"
              class="btn-close justify-content-end" data-bs-dismiss="alert"
              aria-label="Close"></button></p>
        </div>
      @endif
      <div class="col">
        {{-- Modal Button --}}
        <button type="button" class="btn btn-orange text-light"
          data-bs-toggle="modal" data-bs-target="#addSurveyModal"><i
        ...
        <div class="modal fade" id="addSurveyModal" tabindex="-1"
          aria-labelledby="addSurveyModalLabel" aria-hidden="true">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <form action="{{ route('researcher.surveys.store') }}"
                method="POST">
                @csrf
                      ...
                      <div class="col">
                        ...
                        <div class="form-group my-3">
                          ...
                          <textarea class="form-control" name="description"
                            id="description" rows="3" placeholder=""
                            required></textarea>
                        </div>
                      </div>
                    </div>
        ...
        <form>
          <div class="input-group">
            <input class="form-control" type="search"
              placeholder="Cari Judul Survey" aria-label="Cari Judul Survey"
              aria-describedby="btnNavbarSearch" />
            <button class="btn btn-default text-light" id="btnNavbarSearch"
            ...
            <div class="row text-center">
              <div class="col">
                ...
                <a href="/researcher/create-survey">
                  <img src="/assets/img/ic_edit.svg" alt="Edit Design"
            ...
            <div class="row text-center">
              <div class="col">
                ...
                <a href="/researcher/analytics-result">
                  <img src="/assets/img/ic_report.svg" alt="Report"
                    class="img-fluid" width="24">
                </a>
              </div>
            </div>
            ...
            <div class="row text-center">
              <div class="col">
                ...
                <a href="/researcher/status-survey">
                  <img src="/assets/img/ic_share.svg" alt="Share"
                    class="img-fluid" width="24">
                </a>
              </div>
            </div>
  ...
  <div class="modal fade" id="pricingModal" tabindex="-1"
    aria-labelledby="pricingModalLabel" aria-hidden="true" role="dialog">
          ...
          <section class="pricing" id="pricing">
            <div class="row justify-content-center text-center">
              <div class="col">
                ...
                {{-- Tab --}}
                <ul class="nav justify-content-center mt-4" id="myTab"
                  role="tablist">
                  <li class="nav-item">
                    <a class="nav-link link-pricing link-secondary"
                      aria-current="page" href="#" id="pay-per-survey-tab"
                      data-bs-toggle="tab" data-bs-target="#pay-per-survey"
                      type="button" role="tab" aria-controls="pay-per-survey"
                      aria-selected="true">
                ...
                <div class="tab-content" id="myTabContent">
                  <div class="tab-pane fade" id="pay-per-survey" role="tabpanel"
                    ...
                    <div class="container">
                      <div class="row justify-content-center business-price mb-5"
                        id="business-price">
                        <div class="col-md-4">
