  ...
  <section class="sign-in-form" id="sign-in-form">
    <div class="row">
      <div class="col-md-5 bg-default py-5 ps-5 text-white">
        ...
        <img src="{{ url('assets/img/ellipse_green.png') }}" alt="Log In"
      ...
      <div class="col-md-7 sign-in-right justify-content-center">
        ...
        <form action="" method="POST">
          ...
          <div class="mt-3">
            ...
            <input type="email"
              ...
              placeholder="Ketik email Anda" autofocus required
              value="{{ old('email') }}" />
            @error('email')
        ...
        <div class="d-flex justify-content-center">
          <a href=""><img src="{{ url('assets/img/btn_google.png') }}"
              alt="Google" /></a>
          <a href=""><img src="{{ url('assets/img/btn_linkedin.png') }}"
              alt="LinkedIn" /></a>
          <a href=""><img src="{{ url('assets/img/btn_facebook.png') }}"
              alt="Facebook" /></a>
        </div>
