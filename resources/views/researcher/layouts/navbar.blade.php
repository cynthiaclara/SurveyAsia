<nav class="sb-topnav navbar navbar-expand navbar-light bg-light shadow-sm">
  <!-- Sidebar Toggle-->
  <button class="btn btn-link btn-sm order-1 order-lg-0 ms-4 ms-lg-0"
    id="sidebarToggle" href="#"><i class="fas fa-bars"></i></button>
  <!-- Navbar Brand-->
  <a class="navbar-brand ps-3" href="/"><img src="/assets/img/surveyasia.png"
      ...
      <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end"
          ...
          <li><a class="dropdown-item" href="/profile"><i
                class="fas fa-user fa-fw"></i> Profile</a></li>
          <li><a class="dropdown-item" href="/validate"><i
