      ...
      <section class="question-form mb-5 px-5" id="question-form">
        ...
        <div class="row justify-content-between">
            ...
            <ul class="nav" id="myTab" role="tablist">
              <li class="nav-item" role="presentation">
                <a class="nav-link link-question link-secondary link-default text-decoration-underline"
                  aria-current="page" href="#" id="question-tab" data-bs-toggle="tab" data-bs-target="#question"
                  type="button" role="tab" aria-controls="question" aria-selected="true">
                  Pertanyaan
                </a>
              </li>
              <li class="nav-item">
          ...
          <div class="col text-end me-4">
            <a href="#" class="link-secondary text-decoration-none"><i class="far fa-eye fa-fw"></i> Preview</a>
          </div>
        </div>
        {{-- End Tab --}}
        <div class="tab-content" id="myTabContent">
            ...
            <div class="container" id="additional-question-container">
              <div class="row justify-content-center additional-question mb-5" id="additional-question">
                <div class="col">
                  <form action="#">
                    @csrf
                    <div class="border rounded mt-3 p-3" id="survey-additional-question">
                      <div class="col-md-12">
                        <div class="row">
                          <p>Pertanyaan anda</p>
                          <div class="col-9">
                        ...
                        <div class="additional-answer-div" id="additional-answer-div">
                          <div class="row survey-additional-answer mt-2" id="survey-additional-answer">
                            <div class="col-10">
                              <div class="form-check">
                                <input class="form-check-input" type="radio" name="flexRadioDefault" id="myAnswer">
                                <input type="text" class="form-control" id="myAnswer" aria-describedby="emailHelp"
                            ...
                            <div class="col-2 text-center">
                              <button type="button" id="btn-remove-additional-answer"
                                class="btn btn-link link-secondary text-decoration-none"
                                onclick="removeAdditionalAnswer()"><i class="fas fa-minus-circle fa-fw"></i>
                              </button>
                              <button type="button" id="btn-add-additional-answer"
                                class="btn btn-link link-secondary text-decoration-none"
                                onclick="addAdditionalAnswer()"><i class="fas fa-plus-circle fa-fw"></i>
                              </button>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col text-end">
                            <button type="button" id="btn-remove-additional-question"
                              class="btn btn-link link-secondary text-decoration-none"
                              onclick="removeAdditionalQuestion()"><i class="fas fa-trash-alt fa-fw"></i> Hapus
                            </button>
                            <button type="button" id="btn-add-additional-question"
                              class="btn btn-link link-secondary text-decoration-none"
                              onclick="addAdditionalQuestion()"><i class="fas fa-file-medical fa-fw"></i> Tambah
                            </button>
                          </div>
                        </div>
                      </div>
