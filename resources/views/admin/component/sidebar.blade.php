<nav class="nav flex-column  bg-special-black" style="min-height: 900px" id="sidebar-dashboard">
    ...
    <a href="{{ route('admin_dashboard') }}" class="text-decoration-none">
        <div class="d-flex align-items-center px-4 py-3">
            <img src="{{ asset('assets/img/vec-dashboard.svg') }}" alt="" width="16px" height="16px">
            <span class="ms-3 text-sidebar" aria-current="page" href="#">Dashboard</span>
        </div>
    </a>
    <a href="#" class="text-decoration-none">
        <div class="d-flex align-items-center px-4 py-3">
            <img src="{{ asset('assets/img/vec-transaksi.svg') }}" alt="" width="16px" height="16px">
            <span class="ms-3 text-sidebar" aria-current="page" href="#">Transaksi</span>
        </div>
    </a>
    <a href="#" class="text-decoration-none">
        <div class="d-flex align-items-center px-4 py-3">
            <img src="{{ asset('assets/img/vec-question-bank.svg') }}" alt="" width="16px" height="16px">
            <span class="ms-3 text-sidebar" aria-current="page" href="#">Question Bank</span>
        </div>
    </a>
    <a href="#" class="text-decoration-none">
        <div class="d-flex align-items-center px-4 py-3">
            <img src="{{ asset('assets/img/vec-template.svg') }}" alt="" width="16px" height="16px">
            <span class="ms-3 text-sidebar" aria-current="page" href="#">Template</span>
        </div>
    </a>
    <a href="#" class="text-decoration-none">
        <div class="d-flex align-items-center px-4 py-3">
    ...
    <a href="#" class="text-decoration-none">
        <div class="d-flex align-items-center px-4 py-3">
            <img src="{{ asset('assets/img/vec-settings.svg') }}" alt="" width="16px" height="16px">
            <span class="ms-3 text-sidebar" aria-current="page" href="#">Settings</span>
        </div>
    </a>
    <a href="#" class="text-decoration-none">
        <div class="d-flex align-items-center px-4 py-3">
            <img src="{{ asset('assets/img/vec-subscription.svg') }}" alt="" width="16px" height="16px">
            <span class="ms-3 text-sidebar" aria-current="page" href="#">Subscription</span>
        </div>
    </a>
