          ...
          <form action="{{ route('register') }}" method="post">
            ...
            <div class="col-md-12 border rounded p-4">
              ...
              <div class="mb-3">
                <label for="nik" class="form-label">NIK (Nomor Induk
                  Kependudukan) *</label>
                <input type="text" class="form-control" id="nik" name="nik" aria-describedby="nikHelp" required
                  value="{{ old('nik') }}">
                @error('nik')
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="first_name" name="first_name"
                  aria-describedby="firstNameHelp" required value="{{ old('first_name') }}">
                @error('first_name')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="job" name="job" aria-describedby="jobHelp" required
                  value="{{ old('job') }}">
                @error('job')
                <div class="invalid-feedback">
                  {{ $message }}
            ...
            <div class="col-md-12 border rounded p-4">
              <div class="mb-3">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="address" class="form-control" id="city" name="ktp_city" aria-describedby="cityHelp"
                      required value="{{ old('ktp_city') }}">
                    @error('ktp_city')
                    <div class="invalid-feedback">
                      {{ $message }}
                    </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="address" class="form-control" id="zipCode" name="ktp_postal_code"
                      aria-describedby="zipCodeHelp" required value="{{ old('ktp_postal_code') }}">
              ...
              <div class="checkbox mt-3">
                <label>
                  <input type="checkbox" name="similar_address" id="checkbox" value="checked" class="address-id-card"
            ...
            <div class="row mt-4">
              ...
              <div class="col-md-6">
                <button type="submit" class="btn btn-default text-white w-100">Selesai</button>
              </div>
            </div>
          </form>
        </div>
