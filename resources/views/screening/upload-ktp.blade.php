  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-8 mt-5 text-center">
        <h4 class="fw-bold">Surveyasia memerlukan KTP anda untuk melakukan validasi
    ...
    <div class="row justify-content-center">
      <div class="col-md-10">
        <div class="card mt-5">
          <div class="card-body">
            <p class="fs-5">Gambar identitas & pas foto harus terbaca jelas</p>
            <p class="text-secondary mb-0">( Gambar tidak kabur, rusak atau terkena pantulan cahaya )</p>
          </div>
        </div>
        <div class="card mt-4">
