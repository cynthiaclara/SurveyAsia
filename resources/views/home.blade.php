    ...
    <div class="container">
        ...
        <div class="row flex-md-row-reverse pt-5">
            ...
            <div class="col-md-5">
                ...
                <a class="btn btn-orange text-light mt-5 py-3 px-5" href="{{ route('register') }}" role="button">Buat
                    Survei</a>
            </div>
        </div>
</section>
...
<section class="services py-5" id="services">
    <div class="container">
        ...
        <div class="row justify-content-center mt-5">
            <div class="col-md-3">
                <a href="{{ route('register') }}" class="btn btn-orange text-white py-3 w-100" role="button">Ayo jadi
                    Researcher</a>
            </div>
        </div>
    </div>
