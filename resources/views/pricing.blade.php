...
<div class="container-fluid text-center">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="row justify-content-center">
                <div class="col-md-6">
                    <p class="text-secondary">Setting up an investment structure, raiding the neccessary capital, and
                        maintaing
            ...
            <div class="row my-3">
                <div class="col-md-4 my-3">
                    <h4 class="text-orange fw-bold mb-5 text-decoration-underline">Personal</h4>
                    <div class="rounded p-3">
                        <h5 class="text-orange">Basic</h5>
                        <p class="text-secondary">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Autem quo
                            sint,
                            sed repellat eius quam?
                        </p>
                        <h5 class="text-orange">Rp210.000</h5>
                        <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, labore.
                        </p>
                        <a class="btn btn-orange text-light w-50 mb-3" href="/researcher/payment" role="button">Beli</a>
                        <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, labore.
                        </p>
                ...
                <div class="col-md-4  my-3">
                    ...
                    <div class="rounded p-3">
                        ...
                        <h5 class="text-orange">Rp530.000</h5>
                        <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, labore.
                        </p>
                        <a class="btn btn-orange text-light w-50 mb-3" href="/researcher/payment" role="button">Beli</a>
                        <p class="text-secondary">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, labore.
    ...
    <div class="row py-5 comparison-price justify-content-center">
        <h2 class="text-default fw-bold">Komparasi Harga</h2>
        <div class="col-md-3 mt-5 p-3">
            <h5 class="text-default fw-bold mb-4">Features</h5>
            <p class="text-default">Lorem ipsum dolor sit amet</p>
            <p class="text-default">Lorem ipsum dolor sit amet</p>
            <p class="text-default">Lorem ipsum dolor sit amet</p>
            <p class="text-default">Lorem ipsum dolor sit amet</p>
            <p class="text-default">Lorem ipsum dolor sit amet</p>
        ...
        <div class="col-md-2 border border-default rounded mt-5 p-3">
            <h5 class="text-default fw-bold mb-4">Basic</h5>
            <p class="text-default"><i class="fas fa-check fa-fw"></i></p>
            <p class="text-default"><i class="fas fa-check fa-fw"></i></p>
            <p class="text-default"><i class="fas fa-check fa-fw"></i></p>
            <p class="text-default"><i class="fas fa-check fa-fw"></i></p>
            <p class="text-default"><i class="fas fa-check fa-fw"></i></p>
