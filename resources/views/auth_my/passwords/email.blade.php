  ...
  <section class="forgot-password-form" id="forgot-password-form">
    <div class="row">
        ...
        <div class="row justify-content-center">
          <div class="col-10 col-sm-8">
            ...
            <p class="mt-3">Dengan bergabung menjadi responden, kamu
              berkesempatan mendapatkan reward menarik.
            </p>
          </div>
        </div>
        <img src="{{ url('assets/img/ellipse_orange_gradient.png') }}"
          alt="Log In"
          class="img-fluid ellipse-orange-gradient position-absolute bottom-0" />
        <img src="{{ url('assets/img/ellipse_orange.png') }}" alt="Log In"
      ...
      <div class="col-md-7 forgot-password-right justify-content-center">
        ...
        <h6 class="mb-5">Masukkan email Anda dan kami akan mengirimkan
          tautan reset</h6>
        <form method="POST" action="{{ route('password.email') }}">
          ...
          <div class="mt-3">
            ...
            <input type="email"
              ...
              aria-describedby="emailHelp" placeholder="Ketik email Anda" required
          ...
          <button type="submit"
            class="btn btn-orange w-100 text-white my-3">Kirimkan saya
            tautannya</button>
        </form>
        <div class="col mt-5 text-center">
          <a href="{{ route('login') }}"
            class="link-info text-decoration-none">Kembali ke
            halaman Masuk</a>
        </div>
      </div>
    </div>
