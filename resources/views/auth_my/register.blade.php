        ...
        <div class="row">
          <div class="col">
            ...
            <input type="text" class="form-control @error('first_name')is-invalid @enderror" name="first_name"
              placeholder="Ketik nama depan Anda" aria-label="Nama Depan" value="{{ old('first-name') }}">
            @error('first_name')
          ...
          <div class="col">
            ...
            <input type="text" class="form-control @error('last_name')is-invalid @enderror" name="last_name"
              placeholder="Ketik Nama belakang Anda" aria-label="Nama Belakang" value="{{ old('last-name') }}">
            @error('last_name')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
