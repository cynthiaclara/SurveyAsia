                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('first_name')is-invalid @enderror"
                            name="first_name" placeholder="Ketik nama depan Anda" aria-label="Nama Depan"
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control @error('last_name')is-invalid @enderror" name="last_name"
                            placeholder="Ketik Nama belakang Anda" aria-label="Nama Belakang"
                            value="{{ old('last-name') }}">
                        @error('last_name')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="mt-3">
                        ...
                        <input type="email" class="form-control @error('email')is-invalid @enderror" id="email"
                            name="email" aria-describedby="emailHelp" placeholder="Ketik email Anda" required
                            value="{{ old('email') }}" />
                        @error('email')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="checkbox mt-3">
                        <label>
                            <input type="checkbox" name="checkbox" id="checkbox" value="tac"
                                class="@error('checkbox')is-invalid @enderror" required> Dengan membuat akun berarti
                            Anda menyetujui <a href="#" class="link-dark">Syarat dan
                    ...
                    <button type="submit" class="btn btn-orange w-100 text-white my-5" name="submit">Daftar</button>
            </form>
