...
<section class="sign-in-form" id="sign-in-form">
  <div class="row">
    ...
    <div class="col-md-7 sign-in-right justify-content-center">
      ...
      <form action="{{ route('login') }}" method="POST">
        ...
        <div class="mt-3">
          ...
          <input type="email" class="form-control @error('email')is-invalid @enderror" id="email" name="email"
            aria-describedby="emailHelp" placeholder="Ketik email Anda" autofocus required value="{{ old('email') }}" />
          @error('email')
      ...
      <a href="/password/reset" class="d-flex justify-content-end link-orange text-decoration-none mt-3 mb-5">Lupa
        password?</a>
      ...
      <div class="col mt-5 text-center">
        <p>
          Tidak memiliki akun? <a href="/pilih" class="link-info text-decoration-none fw-bold">Buat
            Akun</a>
        </p>
      </div>
    </div>
