...
@section('content')
  ...
  <section class="change-point-survey pb-5" id="change-point-survey">
    <div class="container">
      {{-- Tab --}}
      <ul class="nav nav-pills mt-5 mb-3 justify-content-center" id="pills-tab"
        role="tablist">
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="pills-transfer-tab"
            data-bs-toggle="pill" data-bs-target="#pills-transfer" type="button"
            role="tab" aria-controls="pills-transfer"
            aria-selected="true">Transfer e-wallet</button>
        </li>
        <li class="nav-item" role="presentation">
          <button class="nav-link" id="pills-top-up-tab"
            data-bs-toggle="pill" data-bs-target="#pills-top-up" type="button"
            role="tab" aria-controls="pills-top-up" aria-selected="false">Isi
            pulsa</button>
        </li>
      </ul>
      <div class="tab-content" id="pills-tabContent">
        <div class="tab-pane fade show active" id="pills-transfer" role="tabpanel"
          ...
          <a class="btn btn-orange rounded-pill text-white my-4 px-5" href="#"
            role="button" data-bs-toggle="modal"
            data-bs-target="#eWalletModal">Tukarkan saldo</a>
          <hr>
          <p>Kami mendukung:</p>
          @for ($i = 1; $i <= 3; $i++) <img
              src="/assets/img/e-wallet_{{ $i }}.png" alt="E-Wallet"
              width="70" class="me-3">
          @endfor
        </div>
        <div class="tab-pane fade" id="pills-top-up" role="tabpanel"
          aria-labelledby="pills-top-up-tab">
          ...
          <p>Kami mendukung:</p>
          @for ($i = 1; $i <= 3; $i++) <img
              src="/assets/img/pulsa_{{ $i }}.png" alt="Pulsa"
              width="70" class="me-3">
          @endfor
        </div>
      </div>
  ...
  <div class="modal fade" id="eWalletModal" tabindex="-1"
    aria-labelledby="eWalletModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body text-center">
          ...
          <img src="/assets/img/ic_succeed.svg" alt="Succeed" width="150"
            class="my-3">
  ...
  <div class="modal fade" id="pulsaModal" tabindex="-1"
    aria-labelledby="pulsaModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="btn-close" data-bs-dismiss="modal"
