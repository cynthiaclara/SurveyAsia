    ...
    <div class="container">
        ...
        <ul class="nav nav-pills mt-5 mb-3 justify-content-center" id="pills-tab" role="tablist">
            ...
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="pills-top-up-tab" data-bs-toggle="pill" data-bs-target="#pills-top-up"
                    type="button" role="tab" aria-controls="pills-top-up" aria-selected="false">Isi pulsa</button>
            </li>
        </ul>
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-transfer" role="tabpanel"
                ...
                <p class="text-muted">(Memerlukan waktu 24 jam untuk pengisian e-wallet)</p>
                <div class="col-md-4">
                ...
                <a class="btn btn-orange rounded-pill text-white my-4 px-5" href="#" role="button"
                    data-bs-toggle="modal" data-bs-target="#eWalletModal">Tukarkan saldo</a>
                <hr>
                <p>Kami mendukung:</p>
            ...
            <div class="tab-pane fade" id="pills-top-up" role="tabpanel" aria-labelledby="pills-top-up-tab">
                ...
                <p class="text-muted">(Memerlukan waktu 24 jam untuk pengisian pulsa)</p>
                <div class="col-md-4">
                    <div class="card border-success py-5">
                        <div class="card-body">
                ...
                <a class="btn btn-orange rounded-pill text-white my-4 px-5" href="#" role="button"
                    data-bs-toggle="modal" data-bs-target="#pulsaModal">Tukarkan saldo</a>
                <hr>
                <p>Kami mendukung:</p>
                @for ($i = 1; $i <= 3; $i++) <img src="/assets/img/pulsa_{{ $i }}.png" alt="Pulsa" width="70"
                    class="me-3">
                    @endfor
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p class="text-secondary">Selamat kamu berhasil menukarkan saldo kamu ke e-wallet</p>
            </div>
            <hr>
            <div class="row px-4">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <img src="/assets/img/ic_succeed.svg" alt="Succeed" width="150" class="my-3">
                <p>30 Sep 2021, 10:30</p>
                <p class="text-secondary">Selamat kamu berhasil menukarkan saldo kamu ke pulsa</p>
            </div>
            <hr>
            <div class="row px-4">
                <div class="col-md-1 d-flex">
