    ...
    <div class="container">
      ...
      <div class="d-flex align-items-start mt-5">
        <div class="nav flex-column nav-pills me-5" id="v-pills-tab" role="tablist"
          ...
          <button class="nav-link active px-5" id="v-pills-survey-tab"
            data-bs-toggle="pill" data-bs-target="#v-pills-survey" type="button"
            role="tab" aria-controls="v-pills-survey"
            aria-selected="true">Survey</button>
          <button class="nav-link" id="v-pills-change-tab"
            data-bs-toggle="pill" data-bs-target="#v-pills-change" type="button"
            role="tab" aria-controls="v-pills-change" aria-selected="false">Tukar
            Poin</button>
        </div>
        <div class="tab-content w-100" id="v-pills-tabContent">
          <div class="tab-pane fade show active" id="v-pills-survey"
            role="tabpanel" aria-labelledby="v-pills-survey-tab">
            <h4 class="fw-bold">Riwayat</h4>
            {{-- Tab --}}
            <ul class="nav nav-pills mt-5 mb-3 justify-content-center"
              id="pills-tab" role="tablist">
              <li class="nav-item" role="presentation">
                <button class="nav-link active" id="pills-survey-tab"
                  data-bs-toggle="pill" data-bs-target="#pills-survey"
                  type="button" role="tab" aria-controls="pills-survey"
                  aria-selected="true">Survey</button>
              </li>
              <li class="nav-item" role="presentation">
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-survey"
                ...
                @for ($i = 0; $i < 9; $i++) <a
                    ...
                    data-bs-target="#approvedModal" role="button"
          ...
          <div class="tab-pane fade" id="v-pills-change" role="tabpanel"
            ...
            <div class="row">
              @for ($j = 0; $j < 6; $j++)
                <div class="col-md-6">
                  <a href="/survey/history/change-point"
                    class="link-dark text-decoration-none">
                    <div class="card mt-4">
                      <div class="card-body text-center">
                        <h4 class="fw-bold">Pulsa</h4>
                        <img src="/assets/img/partner_1.png" alt="Pulsa"
                          class="mt-5">
                      </div>
                    </div>
                  </a>
        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="row justify-content-center">
              <div class="col-md-8">
                <button type="button"
                  class="btn btn-outline-default rounded-pill w-100 my-3"
