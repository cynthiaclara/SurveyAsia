...
@extends('responden.layouts.navbar')
        ...
        <div class="d-flex align-items-start mt-5">
            <div class="nav flex-column nav-pills me-5" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                ...
                <button class="nav-link" id="v-pills-change-tab" data-bs-toggle="pill" data-bs-target="#v-pills-change"
                    type="button" role="tab" aria-controls="v-pills-change" aria-selected="false">Tukar Poin</button>
            </div>
            <div class="tab-content w-100" id="v-pills-tabContent">
                <div class="tab-pane fade show active" id="v-pills-survey" role="tabpanel"
                    aria-labelledby="v-pills-survey-tab">
                    <h4 class="fw-bold">Riwayat</h4>
                    {{-- Tab --}}
                    <ul class="nav nav-pills mt-5 mb-3 justify-content-center" id="pills-tab" role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link active" id="pills-survey-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-survey" type="button" role="tab" aria-controls="pills-survey"
                                aria-selected="true">Survey</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link" id="pills-exchange-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-exchange" type="button" role="tab" aria-controls="pills-exchange"
                                aria-selected="false">Penukaran</button>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="pills-survey" role="tabpanel"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col d-flex align-self-center">
                                            ...
                                            <p class="text-secondary ms-1">Survey Kepuasan Pengguna</p>
                                        </div>
                                        <div class="col-md-2">
                                            <p>21-10-2020</p>
                            ...
                            @for ($i = 0; $i < 9; $i++) <a href="#" data-bs-toggle="modal"
                                data-bs-target="#approvedModal" role="button" class="link-dark text-decoration-none">
                                <div class="card mt-3">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-1 align-self-center">
                        ...
                        <div class="tab-pane fade" id="pills-exchange" role="tabpanel"
                ...
                <div class="tab-pane fade" id="v-pills-change" role="tabpanel" aria-labelledby="v-pills-change-tab">
                    ...
                    <p class="text-muted">Pilihlah dan tukarkan poin Anda dnegan hadiah, silakan pilih dari item di
                        bawah
                        ini
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <p class="fw-bold shadow-sm rounded p-2 my-3">Survey Kepuasan Pelanggan</p>
                    <div class="row">
                        <div class="col">
